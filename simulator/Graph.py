...
class Graph:
    ...
    def __init__(self):
        ...
        self.citiesGraph = networkx.read_edgelist(
            self.file_path_cities,
            create_using=networkx.DiGraph(),
            nodetype=str,
            data=[("to", str)],
        )
        self.numsGraph = networkx.read_edgelist(
            self.file_path_nums,
            create_using=networkx.DiGraph(),
            nodetype=str,
            data=[("to", str)],
        )
        self.petersonGraph = networkx.read_edgelist(
            self.file_path_peterson,
            create_using=networkx.DiGraph(),
            nodetype=str,
            data=[("to", str)],
        )
